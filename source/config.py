...
PREPROCESSED_TEST_IMAGES_FOLDER_PATH = DATA_FOLDER_PATH + "preprocessed_test_images_data" + ls
PREPROCESSED_TEST_AUDIO_FOLDER_PATH = DATA_FOLDER_PATH + "preprocessed_test_audio_data" + ls
...
EXTRACTED_TEST_AUDIO_FOLDER_PATH = DATA_FOLDER_PATH + "extracted_test_audio" + ls

__TRAINING_FACES_FOLDER_PATH = DATA_FOLDER_PATH + "training_faces" + ls
__TESTING_FACES_FOLDER_PATH = DATA_FOLDER_PATH + "testing_faces" + ls
...
# testing Faces
FER_EXTRACTED_tFACES_FOLDER_PATH = __TESTING_FACES_FOLDER_PATH + "FER" +  ls
CK_EXTRACTED_tFACES_FOLDER_PATH = __TESTING_FACES_FOLDER_PATH + "CK+" + ls
RAF_EXTRACTED_tFACES_FOLDER_PATH = __TESTING_FACES_FOLDER_PATH + "RAF" + ls
...
ALL_EXTRACTED_tFACES_FOLDERS = [FER_EXTRACTED_tFACES_FOLDER_PATH, CK_EXTRACTED_tFACES_FOLDER_PATH, RAF_EXTRACTED_tFACES_FOLDER_PATH]
